...
export function getTableDisplayData(
  ...
  const SF_SYNONYMS: Record<string, string[]> = {
    ...
    'countryofbirth': ['country-of-birth', 'country_of_birth', 'countryofbirth', 'birth_country', 'birthcountry', 'nationality', 'citizenship', 'land1', 'country'],
    'birthcountry': ['country-of-birth', 'country_of_birth', 'countryofbirth', 'birth_country', 'birthcountry', 'nationality', 'citizenship', 'land1', 'country'],
    ...
    'preferredlanguage': ['preferred-language', 'preferred_language', 'preferredlanguage', 'language', 'spras', 'nativepreferredlang', 'native_preferred_lang', 'nativepreferredlanguage', 'native_preferred_language'],
    'nativepreferredlang': ['nativepreferredlang', 'native_preferred_lang', 'nativepreferredlanguage', 'native_preferred_language', 'preferred-language', 'preferred_language', 'preferredlanguage', 'language', 'spras'],
